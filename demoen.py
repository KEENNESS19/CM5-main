...
MENU_ITEMS = [
        ...
        ("face_mask", "8vision", "face_mask", lal["DEMOEN"]["MASK"]),
        ("face_decetion", "9vision", "face_decetion", lal["DEMOEN"]["FACETRACK"]),
        ("hands", "10vision", "hands", lal["DEMOEN"]["HANDS"]),
        ("height", "11vision", "handh", lal["DEMOEN"]["HEIGHT"]),
        ("pose", "12vision", "pose_dog", lal["DEMOEN"]["POSE"]),
        ("color", "13vision", "color", lal["DEMOEN"]["COLOR"]),
        ("qrcode", "14vision", "qrcode", lal["DEMOEN"]["QRCODE"]),
        ("group", "15vision", "group", lal["DEMOEN"]["GROUP"]),
        ("wifi_set", "16vision", "wifi_set", lal["DEMOEN"]["WIFISET"]),
        ("language", "17vision", "language", lal["DEMOEN"]["LANGUAGE"]),
        ("volume", "18vision", "volume", lal["DEMOEN"]["VOLUME"]),
        ("device", "19vision", "device", lal["DEMOEN"]["DEVICE"]),
    ]
