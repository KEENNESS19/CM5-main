...
from demos.uiutils import (Button,splash_theme_color,btn_selected,btn_unselected,txt_selected,txt_unselected,
                           color_white,color_red,display,splash,get_font,draw,color_black,lcd_draw_string,lcd_rect,lal)
...
if ipadd=='0.0.0.0':
    ...
    lcd_rect(0,195,320,240,(48,50,73),thickness=-1)
    splash.paste(wifin,(40,200))
    if lal== 'cn':
      text="wifi未连接!"
    else:
      text="no net!"
    lcd_draw_string(draw,75, 200,text, color=color_white, scale=font2)
    net=False
else:
